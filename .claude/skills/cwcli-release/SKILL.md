...
- **The release card's What's Changed copy is written by hand, in the repo, BEFORE the tag is pushed** - `.github/release-notes/v<version>.md`, whose format and the five rules the card must satisfy are owned by `.github/release-notes/README.md`.
