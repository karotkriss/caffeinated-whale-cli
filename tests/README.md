...
`ls tests/e2e/` for the current list. They are not part of the 518/30 count
...
Current overall coverage at 0.37.0, unreleased (518 tests across 30 test files, ~51% overall).
