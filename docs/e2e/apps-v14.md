# Historical E2E evidence: `cwcli apps` on Frappe version-14
...
The apps install and uninstall invocations shown here use the former positional app-name syntax, superseded by the `--app` option; see the [current `apps` usage](../../README.md#apps---manage-frappe-apps).
