...
- **Overall project**: ~55% coverage at 0.37.0, unreleased (518 tests across 30 test files; see the [Testing Directory](./testing/) for the per-module breakdown).
...
- **Test Files**: 30
- **Total Tests**: 518
- **Overall Coverage**: ~55% at 0.37.0 (unreleased)
