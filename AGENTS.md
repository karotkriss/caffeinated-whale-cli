...
- `tests/` - pytest suites (45 `test_*.py` files, ~694 tests); `bench_fakes.py` and `bench_fakes_mb.py` hold the container fakes. See `tests/README.md` for the coverage map.
