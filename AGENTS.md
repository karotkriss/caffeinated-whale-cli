...
- `tests/` - pytest suites (46 `test_*.py` files, ~740 tests); `bench_fakes.py` and `bench_fakes_mb.py` hold the container fakes. See `tests/README.md` for the coverage map.
